...
/***/ function(module, exports, __webpack_require__) {
	...
	var redux_thunk_1 = __webpack_require__(5);
	var reducers = __webpack_require__(6);
	var Tickets_1 = __webpack_require__(8);
	...
	ReactDOM.render(React.createElement(react_redux_1.Provider, {store: store}, React.createElement(Tickets_1.default, null)), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function tickets(state, action) {
	    if (state === void 0) { state = initTickets; }
	    if (action.type === constants_1.TICKET_INIT) {
	        return action.tickets;
	    }
	    else if (action.type === constants_1.TICKET_CHANGE) {
	        return action.tickets;
	    }
	    return state;
	}
...
/***/ function(module, exports) {
	...
	"use strict";
	exports.TICKET_INIT = 'TICKET_INIT';
	exports.TICKET_CHANGE = 'TICKET_CHANGE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tickets = (function (_super) {
	    ...
	    function Tickets() {
	        ...
	        this.socket = actions_1.socket;
	    }
	    Tickets.prototype.componentWillMount = function () {
	        var _this = this;
	        this.socket.on('connect', function () {
	            actions_1.socket.emit('initTicket');
	            actions_1.socket.on('initTicket', function (data) {
	                _this.props.initTicket(data);
	            });
	            actions_1.socket.on('changeTicket', function (data) {
	                _this.props.changeTicket(data);
	            });
	        });
	    };
	    Tickets.prototype.chooseTicket = function (e, x, y) {
	        // console.log(x, y)
	    ...
	    Tickets.prototype.render = function () {
	        ...
	        return (React.createElement("div", null, tickets.map(function (datas, x) {
	            return React.createElement("div", null, datas.map(function (data, y) {
	                return React.createElement("input", {type: 'checkbox', checked: data === 1 ? true : false, onChange: function (e) { return _this.chooseTicket(e, x, y); }});
	            }));
	        })));
	    };
	    return Tickets;
	...
	exports.default = react_redux_1.connect(mapStateToProps, { initTicket: actions_1.initTicket, changeTicket: actions_1.changeTicket, chooseTicket: actions_1.chooseTicket, unChooseTicket: actions_1.unChooseTicket })(Tickets);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.socket = io.connect('http://localhost:8080');
	var initTickets = new Array();
	function _change(tickets) {
	    return {
	        type: constants_1.TICKET_CHANGE,
	        tickets: tickets
	    };
	}
	function initTicket(tickets) {
	    return function (dispatch, getState) {
	        dispatch(_change(tickets));
	    };
	}
	exports.initTicket = initTicket;
	function changeTicket(tickets) {
	    return function (dispatch, getState) {
	        dispatch(_change(tickets));
	    };
	}
	exports.changeTicket = changeTicket;
	function chooseTicket(x, y) {
	    return function (dispatch, getState) {
	        var oldTicket = getState().tickets;
	        var newTicket = oldTicket.slice();
	        newTicket[x][y] = 1;
	        dispatch(_change(newTicket));
	        exports.socket.emit('changeTicket', newTicket);
	    };
	}
	exports.chooseTicket = chooseTicket;
	function unChooseTicket(x, y) {
	    return function (dispatch, getState) {
	        var oldTicket = getState().tickets;
	        var newTicket = oldTicket.slice();
	        newTicket[x][y] = 0;
	...
	exports.unChooseTicket = unChooseTicket;
